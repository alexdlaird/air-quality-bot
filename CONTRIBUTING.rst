...
If you find issues, `report them on GitHub <https://github.com/alexdlaird/air-quality-bot/issues>`_.

If you would like to contribute to the code, the process is pretty simple:

1. Familiarise yourself with the code.
2. Fork `the repository on GitHub <https://github.com/alexdlaird/air-quality-bot>`_ and start implementing changes.
...
Also be sure to review the `Code of Conduct <https://github.com/alexdlaird/air-quality-bot?tab=coc-ov-file#contributor-covenant-code-of-conduct>`_ before
